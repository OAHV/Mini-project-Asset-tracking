...
// Asset Tracking is a way to keep track of the company assets,
// like Laptops, Stationary computers, Phones and so on...
...
// Level 2
// Create a program to create a list of assets (inputs) where the
// final result is to write the following to the console:
...
// You should be able to place items in 3 different offices around the
// world which will use the appropriate currency for that country.
// You should be able to input values in dollars and convert them to
// each currency (based on todays currency charts)
